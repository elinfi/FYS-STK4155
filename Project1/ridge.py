...
for i in range(len(lmbda)):
    polydegree, MSE_mean, MSE_best, R2Score_skl, R2Score_mean, beta_best, best_degree, MSE_mean_sklearn, best_degree_sklearn, best_beta_sklearn = cross_validation(n, maxdegree, noise, n_folds, method, lmbda[i], seed)
