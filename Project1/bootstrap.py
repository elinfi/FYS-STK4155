...
def bootstrap(n, maxdegree, n_bootstrap, noise, method):
...
if __name__ == '__main__':
    ...
    polydegree, MSE_bootstrap, bias_bootstrap, variance_bootstrap = bootstrap(n, maxdegree, n_bootstrap, noise, method)
